...
static u32	LOC_u32FreeRunningOSTicks;
static u16	LOC_u16ISRCounts;
...
void TMU_voidCreateTask();

void TMU_voidStartScheduler(void)
{
...
// Why Attribute makes the compiler knows that the
// context switch that will occur must be performed completely
// return of this function is the 'reti'
// What is reti? It re enables the global interrupt again
// So without the attribute, the functin will  be treated like any normal function
// Thats why this line must be added
