...
SEGMENT_Error_t SEGMENT_Init(u8_t copy_u8portID) {
	...
	if((copy_u8portID >= NUM_OF_PORTS)) {
		...
		GPIO_vidSetPinDirection(PORT_B, PIN_6, PIN_OUTPUT);
		GPIO_vidSetPinDirection(PORT_B, PIN_5, PIN_OUTPUT);
		GPIO_vidSetPinDirection(PORT_A, PIN_2, PIN_OUTPUT);
		GPIO_vidSetPinDirection(PORT_A, PIN_3, PIN_OUTPUT);
...
SEGMENT_Error_t SEGMENT_DISPLAY(u8_t copy_u8portID, u8_t copy_u8pinValue) {
	...
	if((copy_u8portID >= NUM_OF_PORTS)) {
		...
		switch(copy_u8pinValue) {
			case 0:
				GPIO_vidSetPinValue(copy_u8portID, PIN_0, LOGIC_LOW);
				GPIO_vidSetPinValue(copy_u8portID, PIN_1, LOGIC_LOW);
				GPIO_vidSetPinValue(copy_u8portID, PIN_2, LOGIC_LOW);
				GPIO_vidSetPinValue(copy_u8portID, PIN_3, LOGIC_LOW);
				break;
			case 1:
				GPIO_vidSetPinValue(copy_u8portID, PIN_0, LOGIC_HIGH);
				GPIO_vidSetPinValue(copy_u8portID, PIN_1, LOGIC_LOW);
				GPIO_vidSetPinValue(copy_u8portID, PIN_2, LOGIC_LOW);
				GPIO_vidSetPinValue(copy_u8portID, PIN_3, LOGIC_LOW);
				break;
			case 2:
				GPIO_vidSetPinValue(copy_u8portID, PIN_0, LOGIC_LOW);
				GPIO_vidSetPinValue(copy_u8portID, PIN_1, LOGIC_HIGH);
				GPIO_vidSetPinValue(copy_u8portID, PIN_2, LOGIC_LOW);
				GPIO_vidSetPinValue(copy_u8portID, PIN_3, LOGIC_LOW);
				break;
			case 3:
			...
			case 4:
				GPIO_vidSetPinValue(copy_u8portID, PIN_0, LOGIC_LOW);
				GPIO_vidSetPinValue(copy_u8portID, PIN_1, LOGIC_LOW);
				GPIO_vidSetPinValue(copy_u8portID, PIN_2, LOGIC_HIGH);
				GPIO_vidSetPinValue(copy_u8portID, PIN_3, LOGIC_LOW);
				break;
			case 5:
				GPIO_vidSetPinValue(copy_u8portID, PIN_0, LOGIC_HIGH);
			...
			case 8:
				...
				GPIO_vidSetPinValue(copy_u8portID, PIN_1, LOGIC_LOW);
				GPIO_vidSetPinValue(copy_u8portID, PIN_2, LOGIC_LOW);
				GPIO_vidSetPinValue(copy_u8portID, PIN_3, LOGIC_HIGH);
				break;
			case 9:
				GPIO_vidSetPinValue(copy_u8portID, PIN_0, LOGIC_HIGH);
				GPIO_vidSetPinValue(copy_u8portID, PIN_1, LOGIC_LOW);
